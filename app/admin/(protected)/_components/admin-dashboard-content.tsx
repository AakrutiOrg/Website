...
import { SumUpDeviceTestCard } from "@/components/admin/sumup-device-test-card";

export function AdminDashboardContent() {
  const sumUpConfigured = !!getOptionalSumUpEnv();
  ...
  return (
    <div className="space-y-6">
      ...
      <SumUpDeviceTestCard isConfigured={sumUpConfigured} />
    </div>
  );
}
